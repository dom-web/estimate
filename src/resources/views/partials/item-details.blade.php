...
<div class="row align-items-center mb-4">
    ...
    <div class="col-md-2"><input type="number" min="0" class="item-input form-control form-control-lg" data-name="effort" value="0"></div>
    <div class="col-md-3 fs-3 fw-bold text-end">￥<span class="item_total">0</span></div>
</div>
<div class="row">
    <div class="col-md-3">
        <select class="item-input form-select form-select-lg" data-name="diff">
    ...
    <div class="col-md-3">
        <select class="item-input form-select form-select-lg" data-name="acc">
    ...
    <div class="col-md-3">
        <select class="item-input form-select form-select-lg" data-name="cost">
    ...
    <div class="col-md-3">
        <select class="item-input form-select form-select-lg" data-name="risk">
